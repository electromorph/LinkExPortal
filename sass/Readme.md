...
folder are mapped to the application's root namespace, 'LinkExPortal'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "LinkExPortal"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'LinkExPortal' in the same way
as `"LinkExPortal/sass/src"`.
