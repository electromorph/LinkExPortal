Ext.define('LinkExPortal.view.updateProfileAspNet.UpdateProfileAspNetController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.updateprofileaspnet-updateprofileaspnet',
    init: function () {
        var myStore = this.getStore('aspnetuser');
        myStore.on({
            load: {fn: this.finishedLoading, scope: this, single: true},
    ...
    onUpdateAspNetProfileClick: function (button) {
        var myViewModel = this.getViewModel();
